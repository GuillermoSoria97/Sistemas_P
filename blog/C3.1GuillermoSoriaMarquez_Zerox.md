...
3. Explique el resultado observado.
 ...
 Una vez ensamblado el circuito el led se prende y apaga, esto es debio a que el el codigo del arduino asi esta indicado.En un segundo se prende y en otro se apaga.
 
4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

![Evidencia1](../img/E1C3.png)
