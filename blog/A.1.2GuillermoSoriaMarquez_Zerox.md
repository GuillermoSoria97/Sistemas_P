...
1. Utilice el siguiente listado de materiales para la elaboración de la actividad y agregue en la columna Fuente de consulta su enlace _bibliográfico_.
    ...
    | -------- | -------------------------------- | ------------------ |
    | 1        | Sensor Fotoresistencia LDR de 2M |http://www.geekbotelectronics.com/producto/fotoresistencia-gl5537-2mohm/                    |
    | 1        | Resistencia 1k                   | https://www.electrocomponentes.es/resistencias/resistencia-1k-ohm-025w-39-.html                   |
    | 1        | Fuente de alimentación de 5v.    |    https://cdmxelectronica.com/producto/fuente-de-alimentacion-5v-10a/                |
...
1. coloque la imagen finalmente obtenida del circuito ensamblado dentro de su simulador.
2. 
<p align="center">
    <img alt="Logo" src="../img/C1.x_Circuito.png" width=600 height=300>
</p>
